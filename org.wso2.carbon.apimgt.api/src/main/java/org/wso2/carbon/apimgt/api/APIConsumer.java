...
public interface APIConsumer extends APIManager {
    ...
    Map<String, Object> getAllPaginatedAPIsByCategoryIds(String tenantDomain, int start, int end,
			Object categoryIds, String sortType, boolean returnAPItags) throws APIManagementException;

    List<APIIdentifier> getPublishedAPIsByCategoryId(String tenantDomain, final int categoryId)
			throws APIManagementException;
