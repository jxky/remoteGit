...
public interface APIProvider extends APIManager {
    ...
    List<Tag> getTagsOfHaveAPIsByProvider(String providerId) throws APIManagementException;
    ...
    /**
     * add a new category to publisher
     * 
     */
    void addCategory(Category cgy) throws APIManagementException;
    
    void updateCategory(Category cgy) throws APIManagementException;
    ...
    * */
     ...
     */
      ...
      * @throws APIManagementException
      */
     public void removeCategoryIcon(int categoryId)throws APIManagementException;
     public boolean categoryIconExists(int categoryId) throws APIManagementException;
